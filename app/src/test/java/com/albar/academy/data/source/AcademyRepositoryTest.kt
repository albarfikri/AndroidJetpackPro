...
import com.albar.academy.data.source.FakeAcademyRepository
import com.albar.academy.data.source.remote.RemoteDataSource
import com.albar.academy.utils.DataDummy
import com.albar.academy.utils.LiveDataTestUtil
...
class AcademyRepositoryTest {
    ...
    @Test
    // doAnswer.when digunakan ketika memanggil sebuah metode yang membutuhkan callback
    fun getAllCourses() {
        doAnswer { invocation ->
    ...
    fun getCourseWithModules() {
        ...
        // melakukan verify selama 1 kali pengecekan apapun dikelas callback
        verify(remote).getAllCourses(any())
