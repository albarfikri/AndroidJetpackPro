...
import com.albar.academy.data.source.remote.ApiResponse
...
import com.albar.academy.utils.NetworkBoundResource
import com.albar.academy.vo.Resource

// menghubungkan RemoteDataSource
// offline online
class AcademyRepository private constructor(
    ...
    override fun getAllCourses(): LiveData<Resource<List<CourseEntity>>> {
        return object :
            ...
            // reading getAllCourses from localDataSource
